...
var f__27374__auto__ = (function (){var switch__27303__auto__ = (function (state_28483){
var state_val_28484 = (state_28483[(1)]);
if((state_val_28484 === (1))){
var inst_28477 = cljs_http.client.get.cljs$core$IFn$_invoke$arity$variadic(endpoint,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bydidriksson.app.shop.request_opts], 0));
var state_28483__$1 = state_28483;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_28483__$1,(2),inst_28477);
} else {
if((state_val_28484 === (2))){
var inst_28479 = (state_28483[(2)]);
var inst_28480 = new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(inst_28479);
var inst_28481 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(bydidriksson.app.state.state,cljs.core.assoc,new cljs.core.Keyword(null,"shop-items","shop-items",-551022926),inst_28480);
var state_28483__$1 = state_28483;
return cljs.core.async.impl.ioc_helpers.return_chan(state_28483__$1,inst_28481);
} else {
return null;
}
}
...
var statearr_28485 = [null,null,null,null,null,null,null];
(statearr_28485[(0)] = bydidriksson$app$shop$make_remote_call_$_state_machine__27304__auto__);

(statearr_28485[(1)] = (1));

return statearr_28485;
});
var bydidriksson$app$shop$make_remote_call_$_state_machine__27304__auto____1 = (function (state_28483){
while(true){
var ret_value__27305__auto__ = (function (){try{while(true){
var result__27306__auto__ = switch__27303__auto__(state_28483);
...
}catch (e28486){var ex__27307__auto__ = e28486;
var statearr_28487_28510 = state_28483;
(statearr_28487_28510[(2)] = ex__27307__auto__);


if(cljs.core.seq((state_28483[(4)]))){
var statearr_28488_28511 = state_28483;
(statearr_28488_28511[(1)] = cljs.core.first((state_28483[(4)])));
...
var G__28512 = state_28483;
state_28483 = G__28512;
continue;
} else {
...
bydidriksson$app$shop$make_remote_call_$_state_machine__27304__auto__ = function(state_28483){
switch(arguments.length){
case 0:
return bydidriksson$app$shop$make_remote_call_$_state_machine__27304__auto____0.call(this);
case 1:
return bydidriksson$app$shop$make_remote_call_$_state_machine__27304__auto____1.call(this,state_28483);
}
...
var state__27375__auto__ = (function (){var statearr_28489 = f__27374__auto__();
(statearr_28489[(6)] = c__27373__auto__);
