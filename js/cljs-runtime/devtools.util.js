...
var _STAR_print_newline_STAR__orig_val__29895_30069 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__29896_30070 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__29897_30071 = true;
var _STAR_print_fn_STAR__temp_val__29898_30072 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__29897_30071);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__29898_30072);

try{var _STAR_print_level_STAR__orig_val__29899_30074 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29900_30075 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29900_30075);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29899_30074);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__29896_30070);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__29895_30069);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq29893){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq29893));
}));
...
var new_formatters = current_formatters.filter((function (p1__30031_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__30031_SHARP_)));
}));
...
var G__30037_30091 = f;
var target__27833__auto___30092 = G__30037_30091;
if(cljs.core.truth_(target__27833__auto___30092)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30037_30091)].join(''),"\n","target__27833__auto__"].join('')));
}

(target__27833__auto___30092["toString"] = (function (){
...
var G__30038_30093 = "%c%s";
var G__30039_30094 = "color:transparent";
var G__30040_30095 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__30038_30093,G__30039_30094,G__30040_30095) : f.call(null,G__30038_30093,G__30039_30094,G__30040_30095));
...
var vec__30045 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30045,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30045,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__30099__delegate = function (add_fmt,add_args){
...
var G__30099 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__30100__i = 0, G__30100__a = new Array(arguments.length -  1);
while (G__30100__i < G__30100__a.length) {G__30100__a[G__30100__i] = arguments[G__30100__i + 1]; ++G__30100__i;}
  add_args = new cljs.core.IndexedSeq(G__30100__a,0,null);
} 
return G__30099__delegate.call(this,add_fmt,add_args);};
G__30099.cljs$lang$maxFixedArity = 1;
G__30099.cljs$lang$applyTo = (function (arglist__30101){
var add_fmt = cljs.core.first(arglist__30101);
var add_args = cljs.core.rest(arglist__30101);
return G__30099__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq30041){
var G__30042 = cljs.core.first(seq30041);
var seq30041__$1 = cljs.core.next(seq30041);
var G__30043 = cljs.core.first(seq30041__$1);
var seq30041__$2 = cljs.core.next(seq30041__$1);
var G__30044 = cljs.core.first(seq30041__$2);
var seq30041__$3 = cljs.core.next(seq30041__$2);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30042,G__30043,G__30044,seq30041__$3);
}));
...
var seq__30054 = cljs.core.seq(features);
var chunk__30055 = null;
var count__30056 = (0);
var i__30057 = (0);
while(true){
if((i__30057 < count__30056)){
var feature = chunk__30055.cljs$core$IIndexed$_nth$arity$2(null,i__30057);
...
var G__30105 = seq__30054;
var G__30106 = chunk__30055;
var G__30107 = count__30056;
var G__30108 = (i__30057 + (1));
seq__30054 = G__30105;
chunk__30055 = G__30106;
count__30056 = G__30107;
i__30057 = G__30108;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__30054);
if(temp__5735__auto__){
var seq__30054__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__30054__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__30054__$1);
var G__30109 = cljs.core.chunk_rest(seq__30054__$1);
var G__30110 = c__4556__auto__;
var G__30111 = cljs.core.count(c__4556__auto__);
var G__30112 = (0);
seq__30054 = G__30109;
chunk__30055 = G__30110;
count__30056 = G__30111;
i__30057 = G__30112;
continue;
} else {
var feature = cljs.core.first(seq__30054__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__30113 = cljs.core.next(seq__30054__$1);
var G__30114 = null;
var G__30115 = (0);
var G__30116 = (0);
seq__30054 = G__30113;
chunk__30055 = G__30114;
count__30056 = G__30115;
i__30057 = G__30116;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o30062 = temp__5733__auto__;
return (o30062["version"]);
} else {
return null;
}
})() == null);
