...
var f__27374__auto__ = (function (){var switch__27303__auto__ = (function (state_28548){
var state_val_28549 = (state_28548[(1)]);
if((state_val_28549 === (1))){
var inst_28537 = cljs.core.deref(bydidriksson.app.config.configuration);
var inst_28538 = new cljs.core.Keyword(null,"backend","backend",-847489124).cljs$core$IFn$_invoke$arity$1(inst_28537);
var inst_28539 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(inst_28538),"/contact"].join('');
var inst_28540 = [new cljs.core.Keyword(null,"with-credentials?","with-credentials?",-1773202222),new cljs.core.Keyword(null,"json-params","json-params",-1112693596)];
var inst_28541 = [false,form];
var inst_28542 = cljs.core.PersistentHashMap.fromArrays(inst_28540,inst_28541);
var inst_28543 = cljs_http.client.post.cljs$core$IFn$_invoke$arity$variadic(inst_28539,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([inst_28542], 0));
var state_28548__$1 = state_28548;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_28548__$1,(2),inst_28543);
} else {
if((state_val_28549 === (2))){
var inst_28545 = (state_28548[(2)]);
var inst_28546 = cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([inst_28545], 0));
var state_28548__$1 = state_28548;
...
(statearr_28550[(0)] = bydidriksson$app$contact$skicka_$_state_machine__27304__auto__);

(statearr_28550[(1)] = (1));

return statearr_28550;
});
var bydidriksson$app$contact$skicka_$_state_machine__27304__auto____1 = (function (state_28548){
while(true){
var ret_value__27305__auto__ = (function (){try{while(true){
var result__27306__auto__ = switch__27303__auto__(state_28548);
...
}catch (e28551){var ex__27307__auto__ = e28551;
var statearr_28552_28558 = state_28548;
(statearr_28552_28558[(2)] = ex__27307__auto__);


if(cljs.core.seq((state_28548[(4)]))){
var statearr_28553_28559 = state_28548;
(statearr_28553_28559[(1)] = cljs.core.first((state_28548[(4)])));
...
var G__28560 = state_28548;
state_28548 = G__28560;
continue;
} else {
...
bydidriksson$app$contact$skicka_$_state_machine__27304__auto__ = function(state_28548){
switch(arguments.length){
case 0:
return bydidriksson$app$contact$skicka_$_state_machine__27304__auto____0.call(this);
case 1:
return bydidriksson$app$contact$skicka_$_state_machine__27304__auto____1.call(this,state_28548);
}
...
var state__27375__auto__ = (function (){var statearr_28554 = f__27374__auto__();
(statearr_28554[(6)] = c__27373__auto__);
