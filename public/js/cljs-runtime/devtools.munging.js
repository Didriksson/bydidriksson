...
var o30234 = temp__5733__auto__;
var temp__5733__auto____$1 = (o30234["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o30235 = temp__5733__auto____$1;
return (o30235["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27983__auto__ = f;
return (o__27983__auto__["toString"]).call(o__27983__auto__);
} else {
return "";
}
}catch (e30236){var _ = e30236;
return "";
}});
...
try{var o__27983__auto___30453 = t;
(o__27983__auto___30453["cljs$lang$ctorPrWriter"]).call(o__27983__auto___30453,t,writer);
}catch (e30249){var __30454 = e30249;
}
...
var char_code = (function (){var o__27983__auto__ = (new String(char$));
return (o__27983__auto__["charCodeAt"]).call(o__27983__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27983__auto__ = String;
return (o__27983__auto__["fromCharCode"]).call(o__27983__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30254 = num_code;
switch (G__30254) {
case (1):
return (185);
...
var o__27983__auto__ = String;
return (o__27983__auto__["fromCharCode"]).call(o__27983__auto__,superscript_code);
});
/**
...
}catch (e30257){var _e__27990__auto__ = e30257;
return false;
}})())){
...
var vec__30258 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30258,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30266){
var vec__30267 = p__30266;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30267,(0),null);
...
var G__30459 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__30460 = cljs.core.butlast(remaining_tokens);
name_tokens = G__30459;
remaining_tokens = G__30460;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30262){
var G__30263 = cljs.core.first(seq30262);
var seq30262__$1 = cljs.core.next(seq30262);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30263,seq30262__$1);
}));
...
var vec__30278 = cljs.core.split_with((function (p1__30277_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__30277_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30278,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30278,(1),null);
...
var vec__30298 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30298,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30298,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__30472 = cljs.core.rest(remaining_tokens);
var G__30473 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__30472;
name_tokens = G__30473;
continue;
} else {
...
var vec__30305 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30305,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30305,(1),null);
var vec__30308 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30308,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30308,(1),null);
var vec__30311 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30311,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30311,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30311,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30311,(3),null);
...
var vec__30318 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30318,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30318,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30318,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30318,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30318,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30318,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__30321 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30321,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30321,(1),null);
var vec__30324 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30324,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30324,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__30333 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__30333) : devtools.munging.parse_fn_info_deep.call(null,G__30333));
})()));
}
} else {
return fn_info;
...
var G__30499 = (arity + (1));
var G__30500 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30342){
var vec__30343 = p__30342;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30343,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30343,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30362_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__30362_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30363_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__30363_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30368){
var vec__30369 = p__30368;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30369,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30364){
var G__30365 = cljs.core.first(seq30364);
var seq30364__$1 = cljs.core.next(seq30364);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30365,seq30364__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30374__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30374__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30374__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30374__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30375 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30375,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30375,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30375,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30375,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30375,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30375,(5),null);
...
var o__27983__auto__ = f;
return (o__27983__auto__["getBasis"]).call(o__27983__auto__);
});
/**
...
}catch (e30418){var _e__27990__auto__ = e30418;
...
var G__30505 = (obj[cljs.core.first(path)]);
var G__30506 = cljs.core.rest(path);
obj = G__30505;
path = G__30506;
continue;
} else {
...
var _STAR_ = (function (accum,p__30424){
var vec__30425 = p__30424;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30425,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30425,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30433){
var vec__30434 = p__30433;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30434,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30434,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30434,(2),null);
...
var post_process = (function (p__30441){
var vec__30442 = p__30441;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30442,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30442,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30440_SHARP_){
return (obj[cljs.core.first(p1__30440_SHARP_)]);
}),sorted_matches);
