...
var G__39348 = o;
goog.object.set(G__39348,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__39370__i < G__39370__a.length) {G__39370__a[G__39370__i] = arguments[G__39370__i + 0]; ++G__39370__i;}
  args = new cljs.core.IndexedSeq(G__39370__a,0,null);
} 
...
var G__39349 = o;
goog.object.set(G__39349,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__39375__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__39375 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__39375__delegate.call(this,args);};
G__39375.cljs$lang$maxFixedArity = 0;
G__39375.cljs$lang$applyTo = (function (arglist__39378){
var args = cljs.core.seq(arglist__39378);
return G__39375__delegate(args);
});
G__39375.cljs$core$IFn$_invoke$arity$variadic = G__39375__delegate;
return G__39375;
})()
;
} else {
...
var G__39350 = props;
var G__39350__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39350,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39350);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39350__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__39351 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39351,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__39351;
}
})(),id_class);
...
var G__39352 = (cljs.core.count(argv) - first_child);
switch (G__39352) {
case (0):
...
var vec__39353 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39353,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39353,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39353,(2),null);
...
var temp__5739__auto___39384 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___39384 == null)){
} else {
var key_39385 = temp__5739__auto___39384;
(jsprops.key = key_39385);
}
...
var temp__5739__auto___39386 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___39386 == null)){
} else {
var key_39387 = temp__5739__auto___39386;
(jsprops.key = key_39387);
}
...
var temp__5739__auto___39388 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___39388 == null)){
} else {
var key_39389 = temp__5739__auto___39388;
(jsprops.key = key_39389);
}
...
var temp__5739__auto___39390 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___39390 == null)){
} else {
var key_39391 = temp__5739__auto___39390;
(jsprops.key = key_39391);
}
...
var temp__5739__auto___39392 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___39392 == null)){
} else {
var key_39393 = temp__5739__auto___39392;
(jsprops.key = key_39393);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39356_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39356_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39357 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39357,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39357,(1),null);
...
break;
default:
var G__39395 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__39396 = compiler;
v = G__39395;
compiler = G__39396;
continue;
...
var G__39361 = tag;
var G__39361__$1 = (((G__39361 instanceof cljs.core.Keyword))?G__39361.fqn:null);
switch (G__39361__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template39363 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template39363 = (function (opts,id,fn_to_element,meta39364){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template39363.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39365,meta39364__$1){
var self__ = this;
var _39365__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template39363(self__.opts,self__.id,self__.fn_to_element,meta39364__$1));
}));

(reagent.impl.template.t_reagent$impl$template39363.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39365){
var self__ = this;
var _39365__$1 = this;
return self__.meta39364;
}));

(reagent.impl.template.t_reagent$impl$template39363.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template39363.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template39363.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template39363.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template39363.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta39364","meta39364",-1283977127,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template39363.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template39363.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template39363");

(reagent.impl.template.t_reagent$impl$template39363.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template39363");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template39363.
 */
reagent.impl.template.__GT_t_reagent$impl$template39363 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template39363(opts__$1,id__$1,fn_to_element__$1,meta39364){
return (new reagent.impl.template.t_reagent$impl$template39363(opts__$1,id__$1,fn_to_element__$1,meta39364));
});

}

return (new reagent.impl.template.t_reagent$impl$template39363(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
