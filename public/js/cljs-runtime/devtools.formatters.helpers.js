...
var G__30512 = devtools.prefs.pref(v);
v = G__30512;
continue;
} else {
return v;
...
}catch (e30464){var _e__27990__auto__ = e30464;
return false;
}})();
...
}catch (e30468){var _e__27990__auto__ = e30468;
return false;
}})();
...
}catch (e30470){var _e__27990__auto__ = e30470;
return false;
}}
}
});
...
var vec__30507 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30507,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30507,(1),null);
...
return cljs.core.some((function (p1__30510_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__30510_SHARP_);
}),template);
});
