...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30752){
var G__30753 = cljs.core.first(seq30752);
var seq30752__$1 = cljs.core.next(seq30752);
var G__30754 = cljs.core.first(seq30752__$1);
var seq30752__$2 = cljs.core.next(seq30752__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30753,G__30754,seq30752__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30845_SHARP_){
return (!((cljs.core.meta(p1__30845_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30846__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30850){var _e__27835__auto__ = e30850;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e30852){var _e__27835__auto__ = e30852;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30854 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30855 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30855);

try{var map__30856 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30856__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30854);
}});
...
var temp__5733__auto___30864 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___30864)){
var managed_print_level_30865 = temp__5733__auto___30864;
var _STAR_print_level_STAR__orig_val__30859_30866 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30860_30867 = managed_print_level_30865;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30860_30867);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30858_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30858_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30859_30866);
}} else {
job_fn();
}
