...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30743){
var G__30744 = cljs.core.first(seq30743);
var seq30743__$1 = cljs.core.next(seq30743);
var G__30745 = cljs.core.first(seq30743__$1);
var seq30743__$2 = cljs.core.next(seq30743__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30744,G__30745,seq30743__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30746_SHARP_){
return (!((cljs.core.meta(p1__30746_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30757__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30765){var _e__27990__auto__ = e30765;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e30768){var _e__27990__auto__ = e30768;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30772 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30773 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30773);

try{var map__30774 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30774__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30772);
}});
...
var temp__5733__auto___30788 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___30788)){
var managed_print_level_30789 = temp__5733__auto___30788;
var _STAR_print_level_STAR__orig_val__30777_30790 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30778_30791 = managed_print_level_30789;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30778_30791);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30776_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30776_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30777_30790);
}} else {
job_fn();
}
