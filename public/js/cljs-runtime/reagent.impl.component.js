...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__39229 = c;
var G__39229__$1 = (((G__39229 == null))?null:G__39229.prototype);
if((G__39229__$1 == null)){
return null;
} else {
return G__39229__$1.render;
}
})() == null)))));
});
...
var or__4126__auto__ = (function (){var G__39240 = c;
var G__39240__$1 = (((G__39240 == null))?null:G__39240.constructor);
if((G__39240__$1 == null)){
return null;
} else {
return G__39240__$1.displayName;
}
})();
...
var G__39241 = c;
var G__39241__$1 = (((G__39241 == null))?null:G__39241.constructor);
if((G__39241__$1 == null)){
return null;
} else {
return G__39241__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__39242 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__39243 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__39243);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__39242);
}});
...
var c = this;
var G__39250_39338 = goog.object.get(c,"cljsRatom");
if((G__39250_39338 == null)){
} else {
reagent.ratom.dispose_BANG_(G__39250_39338);
}
...
var renders_39340 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_39341 = cljs.core.first(cljs.core.vals(renders_39340));
...
if((cljs.core.count(renders_39340) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_39340))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_39341)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_39341], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__39305 = o;
goog.object.set(G__39305,cljs.core.name(k),v);
