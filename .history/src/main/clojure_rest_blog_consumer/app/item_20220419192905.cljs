            ...
            [:div {:class "lg:w-4/5 mx-auto flex flex-wrap"}
             ...
             [:div {:class "lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0"}
              ...
              [:div {:class "flex"}
               ...
               [:button {:class "flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" :on-click #(do
                                                                                                                                                       (println (:cart @state/state))
                                                                                                                                                       (swap! state/state update :cart conj @item))} "Lägg till i varukorg"]]]]]]))))